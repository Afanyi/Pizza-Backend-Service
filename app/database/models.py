...
class PizzaType(Base):
    ...
    description: Mapped[str] = mapped_column(String(50), nullable=False, default='') # solve error for diavolo
                                                                                     # max length of string increased to 50
...
class Topping(Base):
    ...
    stock: Mapped[int] = mapped_column(CheckConstraint(STOCK_ENOUGH), nullable=False)
